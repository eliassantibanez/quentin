...
people = ["Speed", "Racer X", "Spritle", "Chim-Chim"]
...
wages = candidate_database[person][3] * hours
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = send_transaction(w3=w3, account=account, to=candidate_address, wage=wages)
